...
cloudinary.config( 
  cloud_name = "dz6bglmyq", 
  api_key = "219812388389952", 
  api_secret = "ku127QahGg5eDcCxgdV4ml4OmCk" 
)
...
#Get muestras asociadas a un usuairo
...
#Get proyectos asociados a un Usuario
